...
if not counter_data.size:
    ...
    **Tabla de solicitudes de liberación al ambiente con resolución favorable**
    ...
    st.markdown('''Para más información y detalles sobre las distintas solicitudes de liberación al ambiente puede visitar el Registro Nacional de Bioseguridad de los OGM (RNB):''')
